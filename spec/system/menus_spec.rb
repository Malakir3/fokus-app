...
RSpec.describe 'メニュー新規登録', type: :system do
  ...
  context 'メニュー新規登録できる' do
    it '正しい情報を入力すれば新規登録できてトップページに登録したメニューが表示される' do
      ...
      expect(page).to have_content("#{@menu.title}が新規登録されました")
      # トップページに遷移する
      visit root_path
...
RSpec.describe 'メニュー編集', type: :system do
  ...
  context 'メニューを編集して登録できるとき' do
    it '編集後も必要な情報が入力されていれば登録できる' do
      # トップページに移動してサインインする
      sign_in(@user)
      # 登録済みのメニューの画像をクリックすると、メニュー詳細ページに遷移する
      find('img').click
      ...
      expect(page).to have_content("#{@menu.title}編集タイトルの内容が更新されました")
      # トップページに遷移する
      visit root_path
  ...
  context 'メニュー編集できないとき' do
    it '編集後に必要な情報が入力されていなければ登録できない' do
      # トップページに移動してサインインする
      sign_in(@user)
      # 登録済みのメニューの画像をクリックすると、メニュー詳細ページに遷移する
      find('img').click
      ...
      expect(page).to have_no_content("#{@menu.title}編集タイトルの内容が更新されました")
      # トップページに遷移する
      visit root_path
...
RSpec.describe 'メニュー削除', type: :system do
  ...
  context 'メニューを削除できるとき' do
    it '削除ボタンが存在すれば削除できる' do
      ...
      expect(page).to have_content("#{@menu.title}が削除されました")
      # トップページに移動する
      visit root_path
